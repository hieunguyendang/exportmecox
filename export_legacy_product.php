...
$user = 'root';
$password = '123456';
$database = 'mecox_production';
$csv_filename = 'db_export_products_'.date('Y-m-d').'.xls';
...
$product_sql = 'SELECT ev.version_data, ct.title, ct.status, cd.entry_id as id,  cd.field_id_1 as title, cd.field_id_2 as description, cd.field_id_3 as sku, cd.field_id_5 as dimensions,
...
where cd.channel_id = 1 and ct.status = "open" and cd.field_id_6 = "yes" and cd.entry_id = 15295
';
...
header("Expires: 0");
$sep = "\t";
$titles =['index', 'sku', 'post_title', 'post_status', 'lecacy_image', 'images', 'product_gallery', 'featured_image', 'regular_price', 'sale_price', 'category',
